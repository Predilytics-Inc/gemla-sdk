...
GEMLA can evaluate latent embedding trajectories, including embeddings produced by external video, world-model, or agent-trace encoders.

Run the synthetic latent demo:
